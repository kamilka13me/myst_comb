...
export function UserListItem(user: User) {
  ...
  const mediaDropDownList = ({ media }: MediaProps): JSX.Element => {
    ...
    return (
      <ul className="flex flex-wrap items-start justify-start gap-0.5 py-2 min-[900px]:flex-col min-[900px]:px-3 min-[900px]:py-6">
        {media?.length == 1 ? (
  ...
  return (
    <>
      <div
        className={clsx(isOpen ? 'align-top' : 'align-center')}
        onClick={() => {
          toUserPage(user.id);
        }}
      >
        <Text
          ...
          font="sans"
          color="base/text"
          className="py-1 text-[16px] font-normal min-[900px]:py-6 xl:text-[18px]"
        />
      </div>
      <div className={clsx(isOpen ? 'align-top' : 'align-center')}>
        <Text
          ...
          font="sans"
          color="base/text"
          className="py-1 font-normal min-[900px]:py-6"
        />
      </div>
